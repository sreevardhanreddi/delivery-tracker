...
class TrackingEvent(BaseModel):
    ...
    date_time: datetime = Field(..., description="Date and time when the event occurred")
...
class TrackingEvents(BaseModel):
    ...
    """
    events: List[TrackingEvent] = Field(default_factory=list, description="List of tracking events")
